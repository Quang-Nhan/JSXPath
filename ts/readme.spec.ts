import { runPath, runPaths, KEYS } from './index';
...
describe('README.md', () => {
  ...
  describe('Complex Predicates', () => {
    describe('Operator Precedence in Predicates', () => {
      it('[(b/c=1 AND d="test") OR (e > 5)]', () => {
        const json = {
          items: [
    ...
    describe('Nested Predicates', () => {
      it('Filter by nested conditions', () => {
        const json = {
          data: [
    ...
    describe('Complex Sibling Lookups', () => {
      it('sibling::type="user"', () => {
        const json = {
          records: [
