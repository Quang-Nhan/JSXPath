...
describe('Class Json', () => {
  let nodesStateInstance, nodesOps;
  beforeEach(() => {
    nodesStateInstance = new NodesState();
    nodesOps = new NodesOps(nodesStateInstance);
  });
  ...
  describe('reconstruct()', () => {
    ...
    beforeEach(() => {
      ...
      jsonInstance = new Json(nodesOps);
    });

    it('Should return a simple object', () => {
      rootNode = [1, 0, "_", "_", "{$r}", "{$o}", "object", { childrenIds: [2], parentId: null }];
      nodes = [
        rootNode,
    ...
    it('Should return a simple array of objects', () => {
      rootNode = [1, 0, "_", "_", "{$r}", "{$a}", "array", { childrenIds: [2, 3], parentId: null }];
      nodes = [
        rootNode,
        [2, 1, 1, 0, "a", 1, "number", { childrenIds: [], parentId: 1 }],
        [3, 1, 2, 1, "a", 3, "number", { childrenIds: [], parentId: 1 }]
      ];
      nodes.forEach(node => {
        nodesStateInstance.addNode(node);
      });
    ...
    it('Should return an array of nested array', () => {
      rootNode = [1, 0, "_", "_", "{$r}", "{$a}", "array", { childrenIds: [2], parentId: null }];
      nodes = [
        rootNode,
    ...
    it('When passing multiple node items, it should return multiple result', () => {
      const node1: tNode = [2, 1, 1, 0, "a", "{$a}", "array", { childrenIds: [3, 4, 5], parentId: 1 }];
      const node2: tNode = [5, 2, 2, 2, "b", 2, "number", { childrenIds: [], parentId: 2 }];
      nodes = [
    ...
    it('When the passed in node is not cached, it should return undefined value as part of the returned list', () => {
      const node1: tNode = [3, 1, 1, "_", "a", "a", "string", { childrenIds: [], parentId: 1 }];
      const node2: tNode = [2, 1, 1, "_", "a", "a", "string", { childrenIds: [], parentId: 1 }];
      nodes = [
